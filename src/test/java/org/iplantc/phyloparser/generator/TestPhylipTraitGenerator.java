...
public class TestPhylipTraitGenerator extends TestCase {
	public void testEmptyFile() throws Throwable {
		FileData fd = new FileData();
		AbstractPhylipTraitGenerator ptg = new PhylipTraitGenerator();
	...
	public void testNonNumericValueFailure() throws GeneratorException {
		...
		try {
			AbstractPhylipTraitGenerator ptg = new PhylipTraitGenerator();		
			ptg.generate(fd);
			fail("Non-numeric values should cause failure");
